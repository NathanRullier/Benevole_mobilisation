...
- main:
  ...
  - paragraph: Organize workshops in schools, libraries, and community organizations
  - heading "Community Impact" [level=5]
  - paragraph: Build stronger communities through legal education and volunteer engagement
  - heading "System Status" [level=5]
  - alert:
    - strong: "MVP Phase Complete:"
    - text: Backend authentication and profile management systems are operational.
  - alert:
